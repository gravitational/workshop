...
type NginxLister interface {
	...
	List(selector labels.Selector) (ret []*v1.Nginx, err error)
...
// List lists all Nginxes in the indexer.
func (s *nginxLister) List(selector labels.Selector) (ret []*v1.Nginx, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1.Nginx))
	})
	return ret, err
}
...
type NginxNamespaceLister interface {
	...
	Get(name string) (*v1.Nginx, error)
...
// List lists all Nginxes in the indexer for a given namespace.
func (s nginxNamespaceLister) List(selector labels.Selector) (ret []*v1.Nginx, err error) {
